...
class SSD1306(framebuf.FrameBuffer):
    def __init__(self, width, height, external_vcc):
        ...
        super().__init__(
            memoryview(self.buffer)[1:], self.width, self.height, framebuf.MONO_VLSB
        )
    ...
    def scroll_out_screen(self, speed):
        ...
        - speed is a number
        """
        # Cast to int to keep it compatible between MicroPython and CPython.
        for i in range(int((self.width + 1) / speed)):
    ...
    def scroll_out_screen_v(self, speed):
        ...
        """
        # Cast to int to keep it compatible between MicroPython and CPython.
        for i in range(int((self.height + 1) / speed)):

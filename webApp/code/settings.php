...
<!-- Required meta tags -->
    ...
    <?php
        ...
        $sql_max = getFertilizationVolumes();
...
<body class="sidebar-icon-only" >
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                                ...
                                <a class="dropdown-item preview-item" href="index.php">
                                    ...
                                    <div class="preview-item-content">
                                        <p class="preview-subject mb-1">Index</p>
                                    </div>
                                </a>
                                <div class="dropdown-divider"></div>
                                <?php if (!isset($_SESSION["email"]) || !isset($_SESSION["loggedIn"])) {?>
                                  <a class="dropdown-item preview-item" data-iddata-iddata-iddata-id="" data-bs-toggle="modal" data-bs-target="#loginModal">
                                      <div class="preview-thumbnail">
                                          <div class="preview-icon bg-dark rounded-circle">
                                ...
                                <?php }else{ ?>
                                  <a class="dropdown-item preview-item" href= "php/Login/logout_db.php" id="logout">
                                      <div class="preview-thumbnail">
                                          <div class="preview-icon bg-dark rounded-circle">
                                     ...
                                     <tbody>
                                       <tr>  
                                          <form id="addSettingP" name="addSettingP" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsP" id="datepicker_SettingsP" placeholder="<?php echo $sub_array_data[0];?>" /></td>         
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[0];?>" id="addFieldSettingsP" name="Potassio"></td>
                                       ...
                                       <tr>
                                          <form id="addSettingsM" name="addSettingsM" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsM" id="datepicker_SettingsM" placeholder="<?php echo $sub_array_data[1];?>"/></td>
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[1];?>" id="addFieldSettingsM" name="Magnesium"></td>
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                          </form>
                                       </tr> 
                                       <tr>
                                         <form id="addSettingsI" name="addSettingsI" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsI" id="datepicker_SettingsI" placeholder="<?php echo $sub_array_data[2];?>" /></td>
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[2];?>" id="addFieldSettingsI" name="Iron"></td>   
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                         </form>
                                       </tr> 
                                       <tr>
                                         <form id="addSettingsRin" name="addSettingsRin" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsRin" id="datepicker_SettingsRin" placeholder="<?php echo $sub_array_data[3];?>" /></td>
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[3];?>" id="addFieldSettingsRin" name="Rinverdente"></td>
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                         </form> 
                                       </tr> 
                                       <tr>
                                         <form id="addSettingsPho" name="addSettingsPho" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsPho" id="datepicker_SettingsPho" placeholder="<?php echo $sub_array_data[4];?>" /></td>
                                            <td><input type="number" step="any" class="form-control text-center" size="16" value="<?php echo $sub_array[4];?>" id="addFieldSettingsPho" name="Phosphorus"></td>
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                         </form>  
                                       </tr> 
                                       <tr>
                                         <form id="addSettingsN" name="addSettingsN" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsN" id="datepicker_SettingsN" placeholder="<?php echo $sub_array_data[5];?>" /></td>
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[5];?>" id="addFieldSettingsN" name="Nitrogen"></td>
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                         </form> 
                                       </tr>      
                                       <tr>
                                         <form id="addSettingsStick" name="addSettingsStick" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsS" id="datepicker_SettingsS" placeholder="<?php echo $sub_array_data[6];?>" /></td>
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[6];?>" id="addFieldSettingsS" name="Stick"></td>
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                         </form>
                                       </tr>
                                       <tr> 
                                          <form id="addSettingsCo2" name="addSettingsCo2" action="">
                                            ...
                                            <td><input type="text" class="text-center" name="datepicker_SettingsCo2" id="datepicker_SettingsCo2" placeholder="<?php echo $sub_array_data[7];?>" /></td>
                                            <td><input type="number" step="any" class="form-control text-center" value="<?php echo $sub_array[7];?>" id="addFieldSettingsCo2" name="Co2"></td>
                                            <td><div class="text-center"><button type="submit" class="btn btn-primary">Submit</button></div></td>
                                          </form>
                                       </tr>
                                     </tbody>
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                  <H2>PH</H2>
                                  <div class="table-responsive">
                                    <table id="phTableSetting" class="table table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>PH</th>
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                  ...
                                  <div class="table-responsive">
                                    <table id="ecTableSetting" class="table table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>EC</th>
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                  ...
                                  <div class="table-responsive">
                                    <table id="tdsTableSetting" class="table table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>TDS</th>
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                  <H2>Temperature</H2>
                                  <div class="table-responsive">
                                    <table id="tempTableSetting" class="table table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Temperature</th>
    ...
    <script src="js/settingsValuesAdding.js"></script>
    
    <script src="js/fertilizationTable.js"></script>
    <script src="js/waterValuesTable.js"></script>
	<script src="js/settings_handleVolumesDB.js"></script>
    <script src="js/phTableSetting.js"></script>
    <script src="js/ecTableSetting.js"></script>
    <script src="js/tdsTableSetting.js"></script>
    <script src="js/tempTableSetting.js"></script>
                 ...
                 <div class="form-group d-flex align-items-center justify-content-between">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="submit" class="form-check-input">  </label>
                    </div>

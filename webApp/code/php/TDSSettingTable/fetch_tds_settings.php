...
while ($row = $result->fetch_assoc()) {
    ...
    $actions = '<a href="javascript:void(0);" data-id="' . intval($row['id']) . '"'
             . ' class="btn btn-info btn-sm editbtnTdsS"><i class="mdi mdi-table-edit"></i></a>'
             . '  '
             . '<a href="javascript:void(0);" data-id="' . intval($row['id']) . '"'
             . ' class="btn btn-danger btn-sm deleteBtnTdsS"><i class="mdi mdi-table-row-remove"></i></a>';

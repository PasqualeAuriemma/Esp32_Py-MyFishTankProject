...
$TABLE      = 'temp_tab';       // es. ec_tab
$COL_VALUE  = 'temperature';   // es. ec
$COL_DATE   = 'data_send';
...
while ($row = $result->fetch_assoc()) {
    ...
    $actions = '<a href="javascript:void(0);" data-id="' . intval($row['id']) . '"'
             . ' class="btn btn-info btn-sm editbtnTempS"><i class="mdi mdi-table-edit"></i></a>'
             . '  '
             . '<a href="javascript:void(0);" data-id="' . intval($row['id']) . '"'
             . ' class="btn btn-danger btn-sm deleteBtnTempS"><i class="mdi mdi-table-row-remove"></i></a>';
